...
void traj (float *psl1, float *psl2, 
			int fp, float T, float px1, float py1, float pa1, float px2, float py2
			//, float pa2
			)
{
	float sl1 = 0;
...
int ix1, iy1, ia1, ix2, iy2, ia2;
	...
	while (1) 
	{
 		...
 		traj(&sl1,&sl2,1,T,px1,py1,pa1,px2,py2/*,pa2*/);
		printf ("s=%d dp=%f  sl1=%f sl2=%f   px1=%f py1=%f pa1=%f px2=%f py2=%f\n", 
			s, dp, sl1, sl2, px1, py1, pa1, px2, py2);
