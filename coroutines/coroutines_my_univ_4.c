...
int maincor_actions (jmp_buf *mainprog, jmp_buf *myself, jmp_buf *mainprg, int intro)
{
jmp_buf me[1], you[1];
char *answer;
//#define STACK_SIZE 1000
...
int *stack;
	...
	answer = (char *) start (me, you, mainprog, coroutine_actions, (int)"Hello Coroutine, how are you ?", stack+STACK_SIZE);
