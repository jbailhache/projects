...
-}
 ...
 addrefl t = APL (APL (polt LT_P) (APL (APL (polt LT_P) (APL t (polt LT_K))) (APL (APL (polt LT_refl) (rep t)) (polt LT_K))))
                 (APL (polt LT_P) (APL (APL (polt LT_P) (APL t (polt LT_KI))) (APL (APL (polt LT_refl) (rep t)) (polt LT_KI))))

 addreflr : Proof -> Proof
 addreflr rt = APL (polt LT_addrefl) rt
...
-}
 ...
 tirpr rx rt = APL (APL (polt LT_tirp) rx) rt
