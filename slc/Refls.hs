module Refls where
 ...
 mshift1 = fix $ lambda "shift" $ lambda "u" $ lambda "x" $ 
...
\dfg"
 ...
 mshift2str = "\
\ LET B LBD f LBD g LBD x APL f APL g x \
\ LET A LBD x APL x x \
\ LET Y LBD f APL A APL APL B f a \
\ APL Y LBD shift LBD u LBD x \
\  APL APL APL APL " ++ show mequal ++ " x u APL " ++ show mdbs ++ " u \
\  APL APL APL APL APL APL APL x \
\ " ++ show maxm ++ " \
\ " ++ show msmb ++ " \
\ " ++ show mdb0 ++ " \
\  LBD x1 APL " ++ show mdbs ++ " APL APL shift u x1 \
\  LBD x1 APL " ++ show mdbl ++ " APL APL shift APL " ++ show mdbs ++ " u x1 \
\  LBD x1 LBD x2 APL APL " ++ show mapl ++ " APL APL shift u x1 APL APL shift u x2 \
\  LBD x1 LBD x2 APL APL " ++ show mltr ++ " APL APL shift u x1 APL APL shift u x2 \
\"
 mshift2 = slc mshift2str


 mshift3str = "\
\ LBD shift LBD u LBD x \
\  APL APL APL APL " ++ show mequal ++ " x u APL " ++ show mdbs ++ " u \
\  APL APL APL APL APL APL APL x \
\ " ++ show maxm ++ " \
\ " ++ show msmb ++ " \
...
\  LBD x1 LBD x2 APL APL " ++ show mltr ++ " APL APL shift u x1 APL APL shift u x2 \
\"
 mshift3 = fix $ slc mshift3str

 mshift4str = "\
\ LET A LBD x APL x x \
\ LET Y LBD f APL A DBL APL f APL A DB0 \
\ APL Y LBD shift LBD u LBD x \
\  APL APL APL APL " ++ show mequal ++ " x u APL " ++ show mdbs ++ " u \
\  APL APL APL APL APL APL APL x \
\ " ++ show maxm ++ " \
...
\ LET Y LBD f APL A APL APL B f a \
\ APL Y LBD shift LBD u LBD x \
\  APL APL APL APL mequal x u APL mdbs u \
\  APL APL APL APL APL APL APL x \
\  maxm \
\  msmb \
\  mdb0 \
\  LBD x1 APL mdbs APL APL shift u x1 \
\  LBD x1 APL mdbl APL APL shift APL mdbs u x1 \
\  LBD x1 LBD x2 APL APL mapl APL APL shift u x1 APL APL shift u x2 \
\  LBD x1 LBD x2 APL APL mltr APL APL shift u x1 APL APL shift u x2 \
\"
-}
