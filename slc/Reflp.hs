module Refl where
 ...
 maxm = 
  lambda "axm" $ lambda "smb" $ lambda "db0" $ lambda "dbs" $ lambda "dbp" $ lambda "dbl" $ lambda "apl" $ lambda "ltr" $ 
  var "axm"
 ...
 rep (Proof1 DBP x) = apl mdbp (rep x)
 ...
 mequal = fix $ lambda "equal" $ lambda "x" $ lambda "y" $ 
  apl8 (var "x") 
   (apl8 (var "y") mtrue  mfalse mfalse (apl combk mfalse) (apl combk mfalse) (apl combk mfalse) (apl combk $ apl combk mfalse) (apl combk $ apl combk mfalse))
   (apl8 (var "y") mfalse mtrue  mfalse (apl combk mfalse) (apl combk mfalse) (apl combk mfalse) (apl combk $ apl combk mfalse) (apl combk $ apl combk mfalse))
   (apl8 (var "y") mfalse mfalse mtrue  (apl combk mfalse) (apl combk mfalse) (apl combk mfalse) (apl combk $ apl combk mfalse) (apl combk $ apl combk mfalse))
   (lambda "a" $ 
    apl8 (var "y") mfalse mfalse mfalse (apl (var "equal") (var "a")) 
                                                           (apl combk mfalse) (apl combk mfalse) (apl combk $ apl combk mfalse) (apl combk $ apl combk mfalse))
   (lambda "a" $ 
    apl8 (var "y") mfalse mfalse mfalse (apl combk false) (apl (var "equal") (var "a")) 
                                                                              (apl combk mfalse) (apl combk $ apl combk mfalse) (apl combk $ apl combk mfalse))

   (lambda "a" $
    apl8 (var "y") mfalse mfalse mfalse (apl combk mfalse) (apl combk mfalse) (apl (var "equal") (var "a"))
                                                                                                 (apl combk $ apl combk mfalse) (apl combk $ apl combk mfalse))
   (lambda "x1" $ lambda "x2" $
    apl8 (var "y") mfalse mfalse mfalse (apl combk mfalse) (apl combk mfalse) (apl combk mfalse) 
    (lambda "y1" $ lambda "y2" $ apl2 (apl2 (var "equal") (var "x1") (var "y1")) (apl2 (var "equal") (var "x2") (var "y2")) mfalse)
                                                                                                                                (apl combk $ apl combk mfalse))
   (lambda "x1" $ lambda "x2" $ 
    apl8 (var "y") mfalse mfalse mfalse (apl combk mfalse) (apl combk mfalse) (apl combk mfalse) (apl combk $ apl combk mfalse) 
    (lambda "y1" $ lambda "y2" $ apl2 (apl2 (var "equal") (var "x1") (var "y1")) (apl2 (var "equal") (var "x2") (var "y2")) mfalse)
   )
 ...
 mshift = fix $ lambda "shift" $ lambda "u" $ lambda "x" $ 
  ...
  apl8 (var "x")
   ...
   (lambda "x1" $ apl mdbp $ apl2 (var "shift") (var "u") (var "x1"))
 ...
 msubst = fix $ lambda "subst" $ lambda "u" $ lambda "a" $ lambda "b" $
  ...
  apl8 (var "a")
   ...
   (lambda "a1" $ apl mdbp $ apl3 (var "subst") (var "u") (var "a1") (var "b"))
 ...
 mred1 = fix $ lambda "red1" $ lambda "x" $
  apl8 (var "x") 
   ...
   (lambda "x1" $ apl8 (var "x1")
    (apl mdbp maxm)
    (apl mdbp msmb)
    (apl mdbp mdb0)
    (lambda "x2" (var "x2"))
    (lambda "x2" $ apl mdbp $ apl (var "red1") (var "x1"))
    (lambda "x2" $ apl mdbl $ apl mdbp (var "x2"))
    (lambda "x2" $ lambda "y2" $ apl mdbp $ apl (var "red1") (var "x1"))
    (lambda "x2" $ lambda "y2" $ apl mdbp $ apl (var "red1") (var "x1")) )
 ...
 mside = fix $ lambda "side" $ lambda "s" $ lambda "u" $ lambda "v" $ lambda "x" $ apl8 (var "x") 
  ...
  (lambda "x1" $ apl mdbp $ apl4 (var "side") (var "s") (var "u") (var "v") (var "x1"))
 ...
 mmapproof = fix $ lambda "mapproof" $ lambda "f" $
  lambda "x" $ apl8 (var "x") 
   ...
   (apl (var "mapproof") $ lambda "x1" $ apl (var "f") $ apl mdbp (var "x1"))
...
-}
 ...
 meval1 = lambda "eval" $ lambda "x" $ apl8 (var "x")
  ...
  (dbs $ dbs $ dbs db0)
  (lambda "x1" $ dbs $ apl (var "eval") (var "x1"))
  (lambda "x1" $ dbp $ apl (var "eval") (var "x1"))
  {-
  (lambda "x1" $ apl8 (var "x1")
   (dbp axm)
   (dbp smb1)
   (dbp $ dbs $ dbs $ dbs $ dbs db0)
   (lambda "x2" $ apl (var "eval") (var "x2"))
   (lambda "x2" $ dbp $ apl (var "eval") (var "x1"))
   (lambda "x2" $ dbp $ apl (var "eval") (var "x1"))
   (lambda "x2" $ lambda "y2" $ apl (apl (var "eval") (apl mdbp (var "x2"))) (apl (var "eval") (apl mdbp (var "y2"))))
   (lambda "x2" $ lambda "y2" $ ltr (apl (var "eval") (apl mdbp (var "x2"))) (apl (var "eval") (apl mdbp (var "y2")))) )
  -}
  (lambda "x1" $ dbl $ dbp $ apl (var "eval") (var "x1"))
