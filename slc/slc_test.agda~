...
-- Example of a proof that gparent Allan Charles is true
 ...
 lemma1 = rpt 3 RED (APL (APL (APL (RUL "gparent") (SMB "Allan")) (SMB "Brenda")) (SMB "Charles"))
 lemma2 = rpt 3 RED (APL (RUL "axiom1") (APL (APL (APL (SMB "parent") (SMB "Brenda")) (SMB "Charles")) (APL (APL (SMB "gparent") (SMB "Allan")) (SMB "Charles"))))
 lemma3 = LTS lemma2 lemma1
 lemma4 = rpt 3 RED (APL (RUL "axiom2") (APL (APL (SMB "gparent") (SMB "Allan")) (SMB "Charles")))
