module sslcns_tirp where

{- 
 theory with n axioms a0 = b0, ..., an = bn
 represented by t : Nat -> Bool -> Proof
 t n true = an ; t n false = bn
 proofs AXM (or AX0), AXS AXM, AXS (AXS AXM) ...
-}
...
-- variable substitution
 ...
 subst1 u AXM b = AXM
 subst1 u (AXS x) b = AXS (subst u x b)
 subst1 u SMB b = SMB
 subst1 u DB0 b = DB0
...
-}
 ...
 side : (Nat -> Bool -> Proof) -> Nat -> Bool -> Proof -> Proof
 -- side t n s AXM = if s then (APL (t n) (DBL (DBL (DBS DB0)))) else (APL (t n) (DBL (DBL DB0)))
 side t n s AXM = t n s
 side t n s (AXS x) = side t (1+ n) s x
 side _ _ _ SMB = SMB
 side _ _ _ DB0 = DB0
 side _ _ _ (DBS x) = DBS x
 side t n s (DBL x) = DBL (side t n s x)
 side t n s (APL x y) = APL (side t n s x) (side t n s y)
 side t n s (LTR x y) = if red (side t n true x) === red (side t n true y) then (if s then red (side t n false x) else red (side t n false y)) else (LTR x y)
 ...
 abstr _ _ axm = axm
 abstr d v (axs x) = axs (abst d v x)
 abstr _ _ smb = smb
 abstr _ _ db0 = db0
 ...
 LambdaTermOfProof (AXS x) = axs (LambdaTermOfProof x)
 ...
 ProofOfLambdaTerm (axs x) = AXS (ProofOfLambdaTerm x)
...
-- Representations
 ...
 LT_RAXM = lambda "axm" (lambda "axs" (lambda "smb" (lambda "db0" (lambda "dbs" (lambda "dbl" (lambda "apl" (lambda "ltr" (var "axm"))))))))
 LT_RAXS = lambda "x" (lambda "axm" (lambda "axs" (lambda "smb" (lambda "db0" (lambda "dbs" (lambda "dbl" (lambda "apl" (lambda "ltr" (apl (var "axs") (var "x"))))))))))
 LT_RSMB = lambda "axm" (lambda "axs" (lambda "smb" (lambda "db0" (lambda "dbs" (lambda "dbl" (lambda "apl" (lambda "ltr" (var "smb"))))))))
 LT_RDB0 = lambda "axm" (lambda "axs" (lambda "smb" (lambda "db0" (lambda "dbs" (lambda "dbl" (lambda "apl" (lambda "ltr" (var "db0"))))))))
 LT_RDBS = lambda "x" (lambda "axm" (lambda "axs" (lambda "smb" (lambda "db0" (lambda "dbs" (lambda "dbl" (lambda "apl" (lambda "ltr" (apl (var "dbs") (var "x"))))))))))
 LT_RDBL = lambda "x" (lambda "axm" (lambda "axs" (lambda "smb" (lambda "db0" (lambda "dbs" (lambda "dbl" (lambda "apl" (lambda "ltr" (apl (var "dbl") (var "x"))))))))))
 LT_RAPL = lambda "x" (lambda "y" (lambda "axm" (lambda "axs" (lambda "smb" (lambda "db0" (lambda "dbs" (lambda "dbl" (lambda "apl" (lambda "ltr" (apl (apl (var "apl") (var "x")) (var "y")))))))))))
 LT_RLTR = lambda "x" (lambda "y" (lambda "axm" (lambda "axs" (lambda "smb" (lambda "db0" (lambda "dbs" (lambda "dbl" (lambda "apl" (lambda "ltr" (apl (apl (var "ltr") (var "x")) (var "y")))))))))))

 rep : Proof -> Proof
 rep AXM = polt LT_RAXM
 rep (AXS x) = APL (polt LT_RAXS) (rep x)
 ...
 LT_equal = apl LT_Y (lambda "equal" (lambda "x" (lambda "y"
  (apl (apl (apl (apl (apl (apl (apl (apl (var "x")
   (apl (apl (apl (apl (apl (apl (apl (apl (var "y") LT_K) (apl LT_K LT_KI)) LT_KI) LT_KI) (apl LT_K LT_KI)) (apl LT_K LT_KI)) (apl LT_K (apl LT_K LT_KI))) (apl LT_K (apl LT_K LT_KI))) )
   (lambda "a" (apl (apl (apl (apl (apl (apl (apl (apl (var "y") LT_K) (apl (var "equal") (var "a"))) LT_KI) LT_KI) (apl LT_K LT_KI)) (apl LT_K LT_KI)) (apl LT_K (apl LT_K LT_KI))) (apl LT_K (apl LT_K LT_KI)))) )
   (apl (apl (apl (apl (apl (apl (apl (apl (var "y") LT_KI) (apl LT_K LT_KI)) LT_K) LT_KI) (apl LT_K LT_KI)) (apl LT_K LT_KI)) (apl LT_K (apl LT_K LT_KI))) (apl LT_K (apl LT_K LT_KI))) )
   (apl (apl (apl (apl (apl (apl (apl (apl (var "y") LT_KI) (apl LT_K LT_KI)) LT_KI) LT_K) (apl LT_K LT_KI)) (apl LT_K LT_KI)) (apl LT_K (apl LT_K LT_KI))) (apl LT_K (apl LT_K LT_KI))) )
   (lambda "a" (apl (apl (apl (apl (apl (apl (apl (apl (var "y") LT_KI) (apl LT_K LT_KI)) LT_KI) LT_KI) (apl (var "equal") (var "a"))) (apl LT_K LT_KI)) (apl LT_K (apl LT_K LT_KI))) (apl LT_K (apl LT_K LT_KI))) ) )
   (lambda "a" (apl (apl (apl (apl (apl (apl (apl (apl (var "y") LT_KI) (apl LT_K LT_KI)) LT_KI) LT_KI) (apl LT_K LT_KI)) (apl (var "equal") (var "a"))) (apl LT_K (apl LT_K LT_KI))) (apl LT_K (apl LT_K LT_KI))) ) )
   (lambda "x1" (lambda "x2" (apl (apl (apl (apl (apl (apl (apl (apl (var "y") LT_KI) (apl LT_K LT_KI)) LT_KI) LT_KI) (apl LT_K LT_KI)) (apl LT_K LT_KI)) 
 ...
 LT_shift = apl LT_Y (lambda "shift" (lambda "u" (lambda "x" 
  (apl (apl (apl (apl (var "equal") (var "x")) (var "u")) (apl LT_RDBS (var "u")))
   (apl (apl (apl (apl (apl (apl (apl (apl (var "x")
    LT_RAXM )
    (lambda "x1" (apl LT_RAXS (apl (apl (var "shift") (var "u")) (var "x1")))) )
    LT_RSMB )
    LT_RDB0 )
 ...
 LT_subst = apl LT_Y (lambda "subst" (lambda "u" (lambda "a" (lambda "b"
  (apl (apl (apl (apl LT_equal (var "a")) (var "u")) (var "b"))
   (apl (apl (apl (apl (apl (apl (apl (apl (var "a")
    LT_RAXM )
    (lambda "a1" (apl LT_RAXS (apl (apl (apl (var "subst") (var "u")) (var "a1")) (var "b")))) )
    LT_RSMB )
    LT_RDB0 )
 ...
 LT_red1 = apl LT_Y (lambda "red1" (lambda "x" 
  (apl (apl (apl (apl (apl (apl (apl (apl (var "x")
   LT_RAXM )
   (lambda "x1" (apl LT_RAXS (apl (var "red1") (var "x1")))) )
   LT_RSMB )
   LT_RDB0 )
...
{-
 side : (Nat -> Proof) -> Nat -> Bool -> Proof -> Proof
 -- side t n s AXM = if s then (APL (t n) (DBL (DBL (DBS DB0)))) else (APL (t n) (DBL (DBL DB0)))
 side t n s AXM = t n s
 side t n s (AXS x) = side t (1+ n) s x
 side _ _ _ SMB = SMB
...
-}
 ...
 LT_side = apl LT_Y (lambda "side" (lambda "t" (lambda "n" (lambda "s" (lambda "x"
  (apl (apl (apl (apl (apl (apl (apl (apl (var "x")
   -- (apl (apl (var "s") (apl (var "t") LT_K)) (apl (var "t") LT_KI)) 
   -- (apl (apl (var "s") (apl (apl LT_RAPL (apl (var "t") (var "n"))) (repLT LT_K))) (apl (apl LT_RAPL (apl (var "t") (var "n"))) (repLT LT_KI))) )
   (apl (apl (var "t") (var "n")) (var "s")) )
   (lambda "x1" (apl (apl (apl (apl (var "side") (var "t")) (apl LT_suc (var "n"))) (var "s")) (var "x1"))) )
   LT_RSMB )
   LT_RDB0 )
   (lambda "x1" (apl LT_RDBS (apl (apl (apl (apl (var "side") (var "t")) (var "n")) (var "s")) (var "x1")))) )
   (lambda "x1" (apl LT_RDBL (apl (apl (apl (apl (var "side") (var "t")) (var "n")) (var "s")) (var "x1")))) )
   (lambda "x1" (lambda "x2" (apl (apl LT_RAPL (apl (apl (apl (apl (var "side") (var "t")) (var "n")) (var "s")) (var "x1"))) (apl (apl (apl (apl (var "side") (var "t")) (var "n")) (var "s")) (var "x2"))))) )
   (lambda "x1" (lambda "x2" 
    (apl (apl (apl (apl (var "equal") (apl (var "red") (apl (apl (apl (apl (var "side") (var "t")) (var "n")) LT_K) (var "x1")))) (apl (var "red") (apl (apl (apl (apl (var "side") (var "t")) (var "n")) LT_K) (var "x2"))))
    (apl LT_red (apl (apl (apl (apl (var "side") (var "t")) (var "n")) LT_KI) (apl (apl (var "s") (var "x1")) (var "x2")))) )
...
-}
 ...
 LT_map = apl LT_Y (lambda "map" (lambda "f" 
  (lambda "g" (apl (apl (apl (apl (apl (apl (apl (apl (var "g")
   (apl (var "f") LT_RAXM) )
   (apl (var "map") (lambda "x" (apl (var "f") (apl LT_RAXS (var "x"))))) )
   (apl (var "f") LT_RSMB) )
   (apl (var "f") LT_RDB0) )
 ...
 LT_refl = lambda "t" (lambda "s"
  (apl LT_map (lambda "x" (apl LT_eval (apl (apl (apl (apl LT_side (var "t")) LT_zero) (var "s")) (var "x"))))) )

 pair : Proof -> Proof -> Proof
 pair x y = APL (APL (polt LT_P) x) y

{-
 refl : Bool -> Proof -> Proof -> Proof
 refl s a b = polt (lambda "x" (if s then (apl LT_eval (apl LT_side a b s (var "x")))))
-}

{-
 tirp : Ord -> (Nat -> Bool -> Proof) -> Nat -> Bool -> Proof
 tirp Zero t n s = t n s
 -- tirp (Suc x) t n s = pair (tirp x t n s) (refl s (tirp x t n true) (tirp x t n false))
 tirp (Suc x) t O s = APL (APL (polt LT_refl) (rep t)) (rep s)
 tirp (Suc x) t (1+ n) s = tirp x t n s
 tirp (Lim f) t n s = tirp (f (f2 n)) t (f1 n) s
-}
 
{-
 tirp : Ord -> (Nat -> Proof) -> Nat -> Proof
 tirp Zero t n = t n
 tirp (Suc x) t n = pair (tirp x t n) (reflx (tirp x t n))
 tirp (Lim f) t n = tirp (f (f2 n)) t (f1 n)
-}
...
{-
 refl : (Nat -> Proof) -> Proof
 -- refl t = polt (apl LT_refl (lambda "n" (rep (t n))))

 addrefl : (Nat -> Proof) -> Nat -> Proof
 addrefl t O = refl t
 addrefl t (1+ n) = t n
-}
