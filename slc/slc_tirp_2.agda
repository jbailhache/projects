...
-- red1 (APL (APL (APL (APL (APL (APL (APL (APL (APL (APL (SMB "quote") (RUL n)) s) v) l) a) t) r) g) d) e) = APL e (SMB n)
 red1 (APL (APL (APL (APL (APL (APL (APL (APL (APL (APL (SMB "quote") (LFX a' b' x)) s) v) l) a) t) r) g) d) e) = APL (APL (APL g (quot a')) (quot b')) (quot x)
 red1 (APL (APL (APL (APL (APL (APL (APL (APL (APL (APL (SMB "quote") (RGX a' b' x)) s) v) l) a) t) r) g) d) e) = APL (APL (APL d (quot a')) (quot b')) (quot x)
...
-- digits n = cons (mod2 n) (digits (div2 n))
 ...
 f1 : Nat -> Nat
 f1 n = natOfDigits (evenDigits (digits n))
