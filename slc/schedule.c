...
void *schedule (struct coroutine *calling)
{
struct requete r;
/* int x; */
struct requete *r1;
...
void *getctx (struct coroutine *calling, struct process_list *ctx)
{
struct requete r;
struct requete *r1;
	r.op = OP_GETCTX;
...
int setctx (struct coroutine *calling, struct process_list *ctx, void *x)
{
struct requete r;
	r.op = OP_SETCTX;
	r.p[0] = ctx;
...
void *send (struct coroutine *cr, struct canal *cnl, void *x)
{
struct requete r, *r1;
int status;
	r.op = OP_SEND;
...
void *receive (struct coroutine *cr, struct canal *cnl)
{
struct requete r;
struct requete *r1;
	r.op = OP_RECEIVE;
...
void *copy_pl (struct coroutine *cr)
{
struct requete r;
struct requete *r1;
	r.op = OP_COPYPL;
...
struct process_list *insert_process (struct process_list *p, struct process_list *pl)
{
...
void *scheduler (void *(*f) (), void *p, int *astack, int stack_size,
	int options)
{
process_list pl, pp;
struct requete *r;
