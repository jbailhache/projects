...
where \( \beta = \omega_k, \omega_0 = \omega, \omega_{i+1} \) is the least ordinal whose cardinal is greater than the cardinal of \( \omega_i \), and for any \( \xi \in \beta \) or \( \xi < \beta, f(\xi) \) is an ordinal. When \( \beta = \omega, lim_\omega f \) will sometimes be written more simply \( lim f \).
