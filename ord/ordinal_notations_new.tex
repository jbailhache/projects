...
\item \( \psi(\Omega^2+\Omega \times \Omega) = \psi(\Omega^2+\Omega^2) = \psi(\Omega^2 \times 2) = \) limit of :
   ...
   \item \( \psi(\Omega^2+\Omega \times {\varepsilon_0}^2 = \varepsilon_0 \times \omega^{{\varepsilon_0}^2} = \varepsilon_0 \times \omega^{\varepsilon_0 \times \varepsilon_0} = \varepsilon_0 \times (\omega^{\varepsilon_0})^{\varepsilon_0} = \varepsilon_0 \times {\varepsilon_0}^{\varepsilon_0} \)
   \item \( \ldots \)
   \end{itemize}
...
\item \( \psi(\Omega+\Omega) = sup \lbrace 0, \psi(\Omega) = \omega^\omega, \psi(\Omega+\psi(\Omega)) = \psi(\Omega+\omega^\omega) = \omega^\omega+\omega \times \omega^\omega = \omega^\omega \times 2, \ldots \rbrace = \omega^\omega \times \omega = \omega^{\omega+1} \)
...
\item \( \psi(\Omega+\Omega) = \psi(\Omega \times 2) = sup \lbrace 0, \psi(\Omega) = \varepsilon_0, \psi(\Omega+\psi(\Omega)) = \psi(\Omega+\varepsilon_0) = \varepsilon_0 \times \omega^{\varepsilon_0} = \varepsilon_0 \times \varepsilon_0 = {\varepsilon_0}^2, \psi(\Omega+{\varepsilon_0}^2) = \varepsilon_0 \times \omega^{{\varepsilon_0}^2} = \varepsilon_0 \times \omega^{\varepsilon_0 \times \varepsilon_0} = \varepsilon_0 \times (\omega^{\varepsilon_0})^{\varepsilon_0} = \varepsilon_0 \times {\varepsilon_0}^{\varepsilon_0} = {\varepsilon_0}^{1+\varepsilon_0} = {\varepsilon_0}^{\varepsilon_0}, 
\psi(\Omega+{\varepsilon_0}^{\varepsilon_0}) = \varepsilon_0 \times \omega^{{\varepsilon_0}^{\varepsilon_0}} = \varepsilon_0 \times {\varepsilon_0}^{{\varepsilon_0}^{\varepsilon_0}} = {\varepsilon_0}^{1+{\varepsilon_0}^{\varepsilon_0}} = {\varepsilon_0}^{{\varepsilon_0}^{\varepsilon_0}},
\ldots \rbrace = \varepsilon_1 = \varphi(1,1) = \varphi'(0,2) \)

\item \( \psi(\Omega \times \alpha) = \varphi'(0,\alpha) \)

\item \( \psi(\Omega \times \Omega) = \psi(\Omega^2) = sup \lbrace 0, \psi(\Omega \times 0) = \psi(0) = 1, \psi(\Omega \times 1) = \psi(\Omega) = \varepsilon_0 = \varphi'(0,1), \psi(\Omega \times \varphi'(0,1)) = \varphi'(0,\varphi'(0,1)), \ldots \rbrace = \varphi'(1,1) = \varphi(2,0) = \zeta_0 \)

\item \( \psi(\Omega^\alpha) = \varphi(\alpha,0) \)

\item \( \psi(\Omega^\Omega) = sup \lbrace 0, \psi(\Omega^0) = \psi(1) = \omega, \psi(\Omega^\omega) = \varphi(\omega,0), \psi(\Omega^{\varphi(\omega,0)} = \varphi(\varphi(\omega,0),0), \ldots \rbrace = \varphi(1,0,0) = \Gamma_0 \)
...
Let \( \psi_1(\alpha) \) be the smallest ordinal which cannot be expressed from all countable ordinals, \( \Omega \) and \( \Omega _{2} \) using sums, products, exponentials, and the \( \psi _{1} \) function itself (to previously constructed ordinals less than \( \alpha \)), where \( \Omega_2 \) is an ordinal which is greater than all the ordinals which will be constructed using \( \psi_1 \), for example we can take \( \Omega = \omega_1 \) (the least uncountable ordinal) and \( \Omega_2 = \omega_2 \), the least ordinal whose cardinal is strictly greater than the cardinal of \( \omega_1 \).
