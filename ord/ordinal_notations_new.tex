...
\item \( \psi(suc\ \alpha) = f(\psi(\alpha)) \) 

\item \( \psi(lim\ g) = lim (n \mapsto psi(g(n))) = lim(\psi \circ g) \)  
 or with fundamental sequence notation : \( \psi(\alpha)[n] = \psi(\alpha[n]) \)

\item \( \psi(Lim_1 h) = lim [ (\psi \circ h)^\bullet (\zeta) ] \) with \( \zeta = 0 \) or 1 or \( \psi_n(0) \) for example.
...
This family of ordinal collapsing functions can be extended to a family of hierarchies of ordinal collapsing functions \( \psi_n \). 
...
The choice of \( \zeta = 0, 1 \) or \( \psi_n(0) \) is not very important since it does not change the velue of the limit. Traditionaly, \( \psi_n(0) \) is generally chosen, but 0 or 1 seems simpler to me.
...
This family of ordinal collapsing functions can be extended to a family of hierarchies of ordinal collapsing functions \( \psi_\nu \). 
...
The choice of \( \zeta = 0, 1 \) or \( \psi_\nu(0) \) is not very important since it does not change the velue of the limit. Traditionaly, \( \psi_\nu(0) \) is generally chosen, but 0 or 1 seems simpler to me.
