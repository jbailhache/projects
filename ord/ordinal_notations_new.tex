...
\item \( \kappa \) is the \(\kappa\)-th inaccessible cardinal
...
A cardinal \(\kappa\) is hyperinaccessible if it is \(\kappa\)-inaccessible.
...
More generally, \(\kappa\) is hyper\(^\alpha\)-inaccessible if it is hyperinaccessible and for every \( \beta < \alpha \), it is \(\kappa\)-hyper\(^\beta\)-inaccessible, where \(\kappa\) is \(\alpha\)-hyper\(^\beta\)-inaccessible if it is hyper-\(^\beta\)-inaccessible and for every \( \gamma < \alpha \), it is a limit of \(\gamma\)-hyper\(^\beta\)-inaccessible cardinals.
