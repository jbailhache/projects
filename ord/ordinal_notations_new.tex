...
We can define a family of hierarchies of ordinal collapsing functions \( \psi_n (n \in \omega) \) parametrized by the functions z and f, where z is a function that, given a natural number, gives an ordinal, and f is a function that, given an ordinal, gives an ordinal, by : 
