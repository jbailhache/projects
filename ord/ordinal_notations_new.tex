...
\subsection{Back to the recursive approach to ordinal collapsing functions}
...
Other ordinal collapsing functions can be defined similarily by defining the value of \( \psi'(0) \) and of \( \psi'(\alpha+1) = f(\psi'(\alpha)) \) for some function f.
