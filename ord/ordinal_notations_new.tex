...
\item \( cf (lim_\beta f) = \beta \) if there is no ordinal \( \gamma < \beta \) such that \( lim_\beta f = lim_\gamma g \).
...
\item \( cf (\omega \cdot 2) = \omega \)

\item \( cf\ \omega_1 = \omega_1 \)

\item \( cf\ \omega_3 = \omega_3 \)

\item \( cf\ \omega_\omega = \omega \)

\item \( cf\ (\omega_\omega+1) = \omega_\omega+1 \)

\end{itemize}

A regular ordinal is an ordinal which is equal to its cofinality. A singular ordinal is an ordinal which is not regular.
Assuming the axiom of choice, \( \omega_{\alpha+1} \) is regular for any ordinal \( \alpha \). The cofinality of any ordinal is a regular ordinal, which means \( cf(cf\ \alpha) = cf\ \alpha \).
...
\item \( \psi_\nu(Lim_{1+\kappa} h) = Lim_{1+\kappa}(\psi_\nu \circ h) \) if \( \kappa < \nu \), 
 or with fundamental sequence notation : \( \psi_\nu(\alpha)[\eta] = \psi_\nu(\alpha[\eta]) \)
...
\( \psi_2(0) \)          & \( \Omega \)              & \( \Omega \)                          & \( \Omega \)                    & \( \varepsilon_{\Omega+1} \)                                  & \( \varepsilon_{\Omega+1} \)     \\
\hline
\( \psi_2(\alpha+1) \)   & \( \psi_2(\alpha)+1 \)   & \( \psi_2(\alpha)+\omega \)          & \(\psi_2(\alpha)\cdot\omega\) &\(sup\lbrace\psi_2(\alpha)^{\vdots^{\psi_2(\alpha)}}\rbrace\)& \( sup\lbrace\psi_2(\alpha)
                                                                                                                                                                                                  ^{\vdots^{\psi_2(\alpha)}}\rbrace \) \\
\hline
\( \psi_2(1) \)          & \( \Omega+1 \)            & \( \Omega+\omega \)                   & \( \Omega\cdot\omega \)        & \( \varepsilon_{\Omega+2} \)                                  & \( \varepsilon_{\Omega+2} \)     \\
                          &                           &                                       & \( = \omega^{\Omega+1} \)       &                                                               &                                  \\
\hline
\( \psi_2(\alpha) \)     & \( \Omega+\alpha \)       & \( \Omega+\omega\cdot\alpha \)       & \( \Omega\cdot\omega^\alpha \) & \( \varepsilon_{\Omega+1+\alpha} \)                           & \( \varepsilon_{\Omega+1+\alpha} \) \\
                          &                           &                                       & \( = \omega^{\Omega+\alpha} \)  &                                                               &                                  \\
\hline
\( \psi_2(\omega) \)     & \( \Omega+\omega \)       & \( \Omega+\omega^2 \)                 & \( \Omega\cdot\omega^\omega \) & \( \varepsilon_{\Omega+\omega} \)                             & \( \varepsilon_{\Omega+\omega} \) \\
                          &                           &                                       & \( = \omega^{\Omega+\omega} \)  &                                                               &                                  \\
\hline
\( \psi_2(\Omega) \)     & \( \Omega\cdot\omega \)  & \( \Omega\cdot\omega \)               & \( \Omega^2 \)                 & \( \varepsilon_{\Omega \cdot 2} \)                           & \( \varepsilon_{\Omega \cdot 2} \) \\
\hline
