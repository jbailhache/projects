...
We define \( \psi(\Omega) \) as the limit of \( 0, \psi(0), \psi(\psi(0)), \ldots = lim (n \mapsto \psi^n(0)) \), and more generally \( \psi(Lim_1 h) = lim (n \mapsto (\psi \circ h)^n(0))) \).
...
To go beyond this limit, we can either add \( \Omega \) to the basic symbols of our notation, hich would then be based on \( 0, \Omega, \psi \).
