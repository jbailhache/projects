...
\( \zeta_0 = \varphi(2,0) \) is the least fixed point of \( \alpha \mapsto \epsilon_\alpha \) (greater than 0), so \( \zeta_0 = Fix (\alpha \mapsto \epsilon_\alpha) 0 = Fix (\alpha \mapsto Next^{1+\alpha} 0) 0 = Fix (\alpha \mapsto Next^\alpha 0) 0 \) (because the "1+" is "absorbed" after a few iterations) \( = [0] Next\ 0 \). Since \( \zeta_0 \) is also greater than \( \omega \), it is also \( [0] Next\ \omega \) according to a similar computation. 

\( \zeta_1 = \varphi(2,1) \) is the next fixed point of \( \alpha \mapsto \epsilon_\alpha \), the least one which is strictly greater than \( \zeta_0 \), so \( \zeta_1 = Fix (\alpha \mapsto \epsilon_\alpha) \zeta_0 = Fix (\alpha \mapsto Next^\alpha 0) \zeta_0 = [0] Next\ \zeta_0 = [0] Next ([0] Next\ 0) = ([0] Next)^2 0 \).
...
With similar computations it can be shown that \( \varphi(\gamma,\beta,\alpha) = ([0]^\beta (([1] [0])^\gamma Next))^{1+\alpha} 0 = ([0]^\beta (([1] [0])^\gamma Next))^{1+\alpha} \omega, \varphi(\delta,\gamma,\beta,\alpha) = ([0]^\beta (([1] [0])^\gamma (([1]^2 [0])^\delta Next)))^{1+\alpha} 0 \) and so on, the limit being the small Veblen ordinal which is \( [1]^\omega [0] Next\ 0 \) or \( [1]^\omega [0] Next\ \omega \).

Allowing variables at any finite or transfinite positions gives ordinals smaller than the large Veblen ordinal which is \( [2] [1] [0] Next\ 0 \) or \( [2] [1] [0] Next\ \omega \). 

The limit of Next 0, [0] Next 0, [1] [0] Next 0, [2] [1] [0] Next 0, [3] [2] [1] [0] Next 0, ... is called the Bachmann-Howard ordinal (BHO). 
...
zeta_0 = phi(2,0) = least fixed point of (x -> epsilon_x) = Fix (x -> epsilon_x) 0 
 = Fix (x -> Next^(1+x) 0] 0 = Fix (x -> Next^x 0) 0 = [0] Next 0
Next fixed point : zeta_1 = phi(2,1) = Fix (x -> Next^x 0) ([0] Next 0) = [0] Next ([0] Next 0) = ([0] Next)^2 0
zeta_a = phi(2,a) = ([0] Next)^(1+a) 0
eta_0 = phi(3,0) = Fix (x -> zeta_x) 0 = Fix (x -> ([0] Next)^(1+x) 0) 0 = Fix (x -> ([0] Next)^x 0) 0 
 = [0] ([0] Next) 0 = [0]^2 Next 0
eta_a = phi(3,a) = ([0]^2 Next)^(1+a) 0
phi(1+b,a) = ([0]^b Next)^(1+a) 0
Gamma_0 = phi(1,0,0) = least fixed point of x -> phi(x,0) = Fix (x -> phi(x,0)) 0 = Fix (x -> [0]^x Next 0) 0 
 = [1] [0] Next 0
...
Fix f z = f^w (z+1) = H f (suc z)
Next = Fix [w^*]
epsilon_a = phi(1,a) = Next^(1+a) 0
[0] h = Fix [h^* 0]
zeta0 = phi(2,0) = least fixed point of [epsilon_*] = Fix [epsilon_*] 0 = Fix [Next^(1+*) 0] 0 = Fix [Next^* 0] 0 = [0] Next 0
Fix [Next^* 0] 0 = lim 1, Next 0 = epsilon0, Next^epsilon0 0 =Next^(1+epsilon0) 0 = epsilon_epsilon0, ... = epsilon_..._epsilon0 = zeta0
Fix [Next^(1+*) 0] 0 = lim 1, Next^2 0 = Next (Next 0) = epsilon1, ... epsilon_..._epsilon1 = zeta0 
zeta1 = phi(2,1) = second fixed point of [epsilon_*] = Fix [epsilon_*] (zeta0 + 1) = Fix [Next^(1+*) 0] ([0] Next 0) = Fix [Next^* 0] ([0] Next 0)
 = [0] Next ([0] Next 0)
zeta_a = phi(2,a) = ([0] Next)^(1+a) 0
eta0 = phi(3,0) = least fixed point of [zeta_*] = Fix [zeta_*] 0 = Fix [([0] Next)^(1+*) 0] 0 = Fix [([0] Next)^* 0] 0 = [0] ([0] Next) 0 = [0]^2 Next 0
eta1 = phi(3,1) = next fixed point = Fix [zeta_*] ([0]^2 Next 0) = Fix [([0] Next)^(1+*) 0] ([0]^2 Next 0) = Fix [([0] Next)^* 0] ([0]^2 Next 0)
 = [0] ([0] Next) ([0]^2 Next 0) = [0]^2 Next ([0]^2 Next 0) = ([0]^2 Next)^2 0
eta_a = phi(3,a) = ([0]^2 Next)^(1+a) 0

phi(1,a) = Next^(1+a) 0
phi(2,a) = ([0] Next)^(1+a) 0
phi(3,a) = ([0]^2 Next)^(1+a) 0
phi(1+b,a) = ([0]^b Next)^(1+a) 0

Gamma0 = phi(1,0,0) = least fixed point of [phi(*,0)] = least fixed point of [phi(1+*,0)] 
 = Fix [phi(1+*,0)] 0
 = Fix [[0]^* Next 0] 0
 = [1] [0] Next 0
with [1] h g = Fix [h^* g 0]
phi(1,0,1) = next fixed point = Fix [[0]^* Next 0] ([1] [0] Next 0) = [1] [0] Next ([1] [0] Next 0) = ([1] [0] Next)^2 0
phi(1,0,a) = ([1] [0] Next)^(1+a) 0
phi(1,1,0) = least fixed point of [phi(1,0,*)] = Fix [phi(1,0,*)] 0 = Fix [([1] [0] Next)^(1+*) 0] 0 = Fix [([1] [0] Next)^* 0] 0 = [0] ([1] [0] Next) 0
phi(1,1,1) = next fixed point = Fix [([1] [0] Next)^* 0] ([0] ([1] [0] Next) 0) = [0] ([1] [0] Next) ([0] ([1] [0] Next) 0) = ([0] ([1] [0] Next))^2 0
phi(1,1,a) = ([0] ([1] [0] Next))^(1+a) 0
phi(1,2,0) = least fixed point of [phi(1,1,*)] = Fix [([0] ([1] [0] Next))^(1+*) 0] 0 = Fix [([0] ([1] [0] Next))^* 0] 0 = [0] ([0] ([1] [0] Next)) 0 
 = [0]^2 ([1] [0] Next) 0
phi(1,2,1) = next fixed point ...
phi(1,2,a) = ([0]^2 ([1] [0] Next))^(1+a) 0

phi(1,0,a) = ([1] [0] Next)^(1+a) 0
phi(1,1,a) = ([0] ([1] [0] Next))^(1+a) 0
phi(1,2,a) = ([0]^2 ([1] [0] Next))^(1+a) 0
phi(1,b,a) = ([0]^b ([1] [0] Next))^(1+a) 0

phi(2,0,0) = least fixed point of [phi(1,*,0)] = Fix [phi(1,*,0)] 0 = Fix [[0]^* ([1] [0] Next) 0] 0 = [1] [0] ([1] [0] Next) 0) = ([1] [0])^2 Next 0
phi(2,0,a) = (([1] [0])^2 Next)^(1+a) 0
phi(2,1,0) = least fixed point of [phi(2,1,*)] = Fix [phi(2,1,*)] 0 = Fix [(([1] [0])^2 Next)^* 0] 0 = [0] (([1] [0])^2 Next) 0
phi(2,1,a) = ([0] (([1] [0])^2 Next))^(1+a) 0
phi(2,b,a) = ([0]^b (([1] [0])^2 Next))^(1+a) 0
phi(c,b,a) = ([0]^b (([1] [0])^c Next))^(1+a) 0

phi(1,0,0,0) = least fixed point of [phi(*,0,0)] = Fix [phi(*,0,0)] 0 = Fix [([1] [0])^* Next 0] 0 = [1] ([1] [0]) Next 0 = [1]^2 [0] Next 0
phi(1,0,0,a) = ([1]^2 [0] Next)^(1+a) 0
phi(1,0,1,0) = Fix [([1]^2 [0] Next)^* 0] 0 = [0] ([1]^2 [0]) 0
phi (1,0,1,a) = ([0] ([1]^2 [0] Next))^(1+a) 0
phi(1,0,b,a) = ([0]^b ([1]^2 [0] Next))^(1+a) 0
phi(1,1,0,0) = Fix [phi(1,0,*,0)] 0 = Fix [[0]^* ([1]^2 [0] Next) 0] 0 = [1] [0] ([1]^2 [0] Next) 0
phi(1,1,0,a) = ([1] [0] ([1]^2 [0] Next))^(1+a) 0
phi(1,1,1,0) = Fix [phi(1,1,0,*)] 0 = Fix [([1] [0] ([1]^2 [0] Next))^* 0] 0 = [0] ([1] [0] ([1]^2 [0] Next)) 0
phi(1,1,1,a) = ([0] ([1] [0] ([1]^2 [0] next)))^(1+a) 0
phi(1,1,b,a) = ([0]^b ([1] [0] ([1]^2 [0] Next)))^(1+a) 0
phi(1,2,0,0) = Fix [phi(1,1,*,0)] 0 = Fix [[0]^* ([1] [0] ([1]^2 [0] next)) 0] 0 = [1] [0] ([1] [0] ([1]^2 [0] Next)) 0 = ([1] [0])^2 ([1]^2 [0] Next) 0

phi(1,0,0,0) = [1]^2 [0] Next 0
phi(1,1,0,0) = [1] [0] ([1]^2 [0] Next) 0
phi(1,2,0,0) = ([1] [0])^2 ([1]^2 [0] Next) 0
phi(1,c,0,0) = ([1] [0])^c ([1]^2 [0] Next) 0
phi(1,c,b,a) = ([0]^b (([1] [0])^c ([1]^2 [0] Next)))^(1+a) 0
phi(2,0,0,0) = Fix [phi(1,*,0,0)] 0 = Fix [([1] [0])^* ([1]^2 [0] Next) 0] 0 = [1] ([1] [0]) ([1]^2 [0] Next) 0 = [1]^2 [0] ([1]^2 [0] Next) 0 = ([1]^2 [0])^2 Next 0
phi(d,0,0,0) = ([1]^2 [0])^d Next 0
phi(d,c,b,a) = ([0]^b (([1] [0])^c (([1]^2 [0])^d Next)))^(1+a) 0 = (([1]^0 [0])^b (([1]^1 [0])^c (([1]^2 [0])^d Next)))^(1+a) 0

phi(1,0) = Next 0
phi(1,0,0) = [1] [0] Next 0
phi(1,0,0,0) = [1]^2 [0] Next 0
...
SVO = [1]^w [0] Next 0
LVO = [2] [1] [0] Next 0 = [2...0] Next 0
BHO = [w...0] Next 0
