...
\( \varphi_{\ldots,\beta,0,\ldots,0}(\gamma) \) ou  \(\varphi(\ldots,\beta,0,\ldots,0,\gamma) \) est le \((1+\gamma)^{eme}\) point fixe commun aux fonctions \( \xi \mapsto \varphi(\ldots,\delta,\xi,0,\ldots,0)\) pour tous les \(\delta < \beta\).
