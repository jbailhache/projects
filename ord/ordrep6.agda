...
-- Combinators
 ...
 P_insert = lambda "x" (lambda "l" (lambda "f" (APL (var "l") (APL (var "f") (var "x")))))
 P_array = APL P_Y (lambda "array" (lambda "f" (lambda "n" (lambda "x" (APL2 (var "n") (APL (var "f") P_I) (lambda "p" (APL2 (var "array") (lambda "l" (APL (var "f") (APL2 P_insert (var "x") (var "l")))) (var "n"))))))))
...
-}
 ...
 R = APL P_array (lambda "l" (APL2 H (var "l") P_I))
