...
\hline
\( \psi'(\alpha) \) for   & \( \alpha+1 \)            & \( \omega \times \alpha \)            & \( \omega^\alpha \)             & \( \varepsilon'_\alpha \)                                     & \( \varepsilon_\alpha \)         \\
...
\hline
\( \psi'(\Omega+1) \)     & \( \omega+1 \)            & \( \omega^\omega+\omega \)            & \( \varepsilon_0\times\omega \) &                                                               & \( \varepsilon_{\zeta_0+1} \)    \\
                          &                           &                                       & \( = \omega^{\varepsilon_0+1} \)&                                                               &                                  \\
\hline
\( \psi'(\Omega\times 2)\)& \( \omega^2 \)            & \( \omega^{\omega+1} \)               & \( \varepsilon_1 \)             &                                                               & \( \zeta_1 \)                    \\
\hline
\( \psi'(\Omega^2) \)     & \( \varepsilon_0 \)       & \( \varepsilon_0 \)                   & \( \zeta_0 \)                   &                                                               & \( \eta_0 \)                     \\
\hline
\end{tabular}
