...
A cardinal \( \aleph_\alpha \) is said to be a limit cardinal if \( \alpha \) is a limit ordinal.
...
See https://mathoverflow.net/questions/117806/if-k-is-weakly-inaccessible-then-it-is-the-k-th-aleph-fixed-point for the proof.
