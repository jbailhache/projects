...
\( \Omega		\) & \( \varepsilon_0	\) & \( \varepsilon_0 		\) \\ \hline
\( \Omega+1		\) & \( \varepsilon_0 \cdot \omega = \omega^{\varepsilon_0+1} 
						\) & \( \varepsilon_\omega 	\) \\ \hline
\( \Omega \cdot 2 	\) & \( \varepsilon_1	\) & \( \zeta_0			\) \\ \hline
\( \Omega^2 		\) & \( \zeta_0		\) & \( \Gamma_0		\) \\ \hline
\end{tabular}
