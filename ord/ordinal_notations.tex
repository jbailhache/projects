...
\item http://cl-informatik.uibk.ac.at/isr-2008/pdfs/B/klop/material3.pdf
...
\begin{itemize}
     ...
     \setlength{\parsep}{0pt}
\item a = 0
\item a = a' + 1 for some a'
\item a is a function from \( \Omega_k \) to \( \Omega_n \) for some \( k _in \mathbb{N} \) with k < n
\end{itemize}
