...
\subsection{Another approach to ordinal collapsing functions}

Another approach could consist, instead of defining ordinal collapsing functions by taking the least ordinal which cannot be constructed using a given set of ordinals and operations, in defining it recursively according to the value of the variable.
...
Then we must define \( \psi' \) for the case when it collapses an uncountable ordinal, in such a way that \( \psi'(f(\Omega)) \), for f correctly defined, is the least fixed point of \( \psi' \circ f \), which can be written for example \( sup \lbrace 1, \psi'(f(1)), \psi'(f(_psi'(f(1)))), \ldots \rbrace \)  as we previously saw. In RHS0 notation, if we write \( \Omega = H_1 suc\ 0 \), this gives : \( \psi (H_1 x y z_1 \ldots z_n) = H [\psi([suc \rightarrow x, 0 \rightarrow y] \bullet z_1 \ldots z_n)] (suc\ 0) \).
...
Corresponding      &                              & \( \psi'(0) \)           & \( \psi'(\alpha+1) \)          & \( \psi'(1) \)           & \( \psi'(\alpha+\beta) \)          & \( \psi'(\alpha) \)                  & \( \psi'(\Omega) \) \\
"traditional"      &                              &                          &                                &                          &                                    & for sufficiently                     &                     \\
OCF                &                              &                          &                                &                          &                                    & small values                         &                     \\
\hline
None               &                              & 1                        & \( \psi'(\alpha)+1 \)          & 2                        & \( \psi'(\alpha)+\beta \)          & \( \alpha+1 \)                       & \( \omega \)        \\
\hline
                   & \(C(\alpha)\) generated      & 1                        & \( \psi'(\alpha)+\omega \)     & \( \omega \)             &\( \psi'(\alpha)+\omega\times\beta\)& \( \omega\times\alpha \)             & \( \omega^\omega \) \\
                   & by 1, suc, \(\psi(\xi) \)    &                          &                                &                          &                                    &                                      &                     \\
                   & where \( \xi < \alpha \)     &                          &                                &                          &                                    &                                      &                     \\
\hline
Buchholz \(\psi_0\)& \(C_0(\alpha)\) generated    & 1                        & \( \psi'(\alpha)\times\omega\) & \( \omega \)             &\( \psi'(\alpha)\times\omega^\beta\)& \( \omega^\alpha \)                  & \( \varepsilon_0\) \\
                   & by 1, +,\(\psi_\mu(\xi)\)    &                          &                                &                          &                                    & if \(\alpha<\varepsilon_0\)          &                    \\
                   & where \( \mu < \omega \)     &                          &                                &                          &                                    &                                      &                    \\
                   & and \( \xi < \alpha \)       &                          &                                &                          &                                    &                                      &                    \\
\hline
...
Madore's \(\psi\)  & \(C(\alpha)\) generated      & \( \varepsilon_0 \)      & \( sup\lbrace\psi'(\alpha)^{\vdots^{\psi'(\alpha)}}\rbrace \)             
                                                                                                              & \( \varepsilon_1 \)      &                                    & \( \varepsilon_\alpha \)             & \( \zeta_0 \)      \\
                   & by \(0,1,\omega,\Omega,\)    &                          &  
                                                                                                              &                          &                                    & if \(\alpha<\zeta_0\)                &                    \\
                   & \(+,\times,exp.,\psi(\xi)\)  &                          &                                &                          &                                    &                                      &                    \\
                   & where \( \xi < \alpha \)     &                          &                                &                          &                                    &                                      &                    \\
