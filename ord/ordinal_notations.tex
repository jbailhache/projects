...
Madore's \(\psi\)   & \(C(\alpha)\) generated by    & \(\psi(0)=\varepsilon_0\)   & \(\psi(1)=\varepsilon_1\)   & \(\psi(\alpha+1)\)                                         &                                       & \(\psi_0(\alpha)=\varepsilon_\alpha\) & \(\psi_0(\Omega)=\zeta_0\)       \\
                    & \(0,1,\omega,\Omega,\)        &                             &                             & \(=sup\lbrace\psi(\alpha)^{\vdots^{\psi(\alpha)}}\rbrace\) &                                       & if \(\alpha<\zeta_0\)                 &                                  \\
                    & \(+,\times,exp.,\psi(\xi)\)   &                             &                             &                                                            &                                       &                                       &                                  \\  
                    & where \( \xi < \alpha \)      &                             &                             &                                                            &                                       &                                       &                                  \\ \hline
													
\end{tabular}


\subsection{A variant of Madore's \( \psi \) function}
...
Let us call \( \psi' \) this new collapsing function. 
