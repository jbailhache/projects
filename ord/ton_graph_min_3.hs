module Main where
 ...
 pgraph l a s r =  do
  out <- openFile "ton_graph_inc.tex" AppendMode
  hPutStr out (graph s r a)
  hPutStr out ("$" ++ l ++ "$ = $" ++ latex a ++ "$\n")

 main = do
  out <- openFile "ton_graph_inc.tex" WriteMode
  pgraph "1" (C O O) 6 0.8
  pgraph "2" (C O (C O O)) 6 0.8
  pgraph "3" (C O (C O (C O O))) 6 0.8
  pgraph "\\omega" (C (C O O) O) 6 0.8
  pgraph "\\omega+1" (C O (C (C O O) O)) 6 0.8
  pgraph "\\omega \\cdot 2" (C (C O O) (C (C O O) O)) 10 0.6
  pgraph "\\omega \\cdot 2+1" (C O (C (C O O) (C (C O O) O))) 10 0.6
  pgraph "\\omega^2" (C (C O (C O O)) O) 6 0.8
  pgraph "\\omega^\\omega" (C (C (C O O) O) O) 6 0.8
  pgraph "\\text{In system 1, with } \\Omega = \\Omega_1 :$\n\n$\\varepsilon_0 = \\varphi(1,0) = \\varphi'(0,1) = Next\\ \\omega = R_1 H suc\\ 0" (C W O) 6 0.8
  pgraph "\\varepsilon_0+1" (C O (C W O)) 6 0.8
  pgraph "\\varepsilon_0+2" (C O (C O (C W O))) 6 0.8
  pgraph "\\varepsilon_0+\\omega" (C (C O O) (C W O)) 10 0.6
  pgraph "\\varepsilon_0+\\omega \\cdot 2" (C (C O O) (C (C O O) (C W O))) 10 0.6
  pgraph "\\varepsilon_0+\\omega^2" (C (C O (C O O)) (C W O)) 6 0.8
  pgraph "\\varepsilon_0+\\omega^\\omega" (C (C (C O O) O) (C W O)) 10 0.6
  pgraph "\\varepsilon_0 \\cdot 2" (C (C W O) (C W O)) 10 0.6
  pgraph "\\varepsilon_0 \\cdot \\omega" (C (C O (C W O)) (C W O)) 10 0.6
  pgraph "{\\varepsilon_0}^2" (C (C (C W O) (C W O)) (C W O)) 10 0.6
  pgraph "{\\varepsilon_0}^\\omega" (C (C (C O (C W O)) (C W O)) (C W O)) 10 0.6
  pgraph "{\\varepsilon_0}^{\\varepsilon_0}" (C (C (C (C W O) (C W O)) (C W O)) (C W O)) 10 0.6
  pgraph "\\varepsilon_1 = \\varphi(1,1) = \\varphi'(0,2)" (C W (C W O)) 6 0.8
  pgraph "\\varepsilon_\\omega = \\varphi(1,\\omega) = \\varphi'(0,\\omega)" (C (C O W) O) 6 0.8
  pgraph "\\varepsilon_{\\omega^2}" (C (C O (C O W)) O) 6 0.8
  pgraph "\\varepsilon_{\\varepsilon_0}" (C (C (C W O) W) O) 6 0.8
  pgraph "\\zeta_0 = \\varphi(2,0) = \\varphi'(1,1) = [0] Next\\ \\omega = R_2 R_1 H suc\\ 0" (C (C W W) O) 6 0.8
  pgraph "\\zeta_1 = \\varphi(2,1) = \\varphi'(1,2)" (C (C W W) (C (C W W) O)) 10 0.6
  pgraph "\\eta_0 = \\varphi(3,0) = \\varphi'(2,1)" (C (C W (C W W)) O) 6 0.8
  pgraph "\\Gamma_0 = \\varphi(1,0,0) = \\varphi'(1,0,1) = [1] [0] Next\\ \\omega = R_3 R_2 R_1 H suc\\ 0" (C (C (C W W) W) O) 6 0.8
  pgraph "\\Gamma_1 = \\varphi(1,0,1) = \\varphi'(1,0,2)" (C (C (C W W) W) (C (C (C W W) W) O)) 10 0.6
  pgraph "\\Gamma_\\omega = \\varphi(1,0,\\omega) = \\varphi'(1,0,\\omega)" (C (C O (C (C W W) W)) O) 6 0.8

  pgraph "\\text{LVO} = [2] [1] [0] Next\\ \\omega = R_4 R_3 R_2 R_1 H suc\\ 0" (C (C (C (C W W) W) W) O) 6 0.8
  pgraph "\\text{In system 2, with } \\Omega = \\Omega_2 :$\n\n$\\text{BHO} = [\\omega \\ldots 0] Next\\ \\omega = R_{\\omega \\ldots 1} H suc\\ 0" (C (C W (C W O)) O) 6 0.8 
  pgraph "\\text{TFBO}" (C (C W (C (C O W) O)) O) 6 0.8
